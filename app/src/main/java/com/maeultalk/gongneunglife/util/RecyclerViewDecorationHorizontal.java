...
public class RecyclerViewDecorationHorizontal extends RecyclerView.ItemDecoration {
    private final int divHeightPX;
    Context context;

    public RecyclerViewDecorationHorizontal(Context context, int divHeightDP) {

...
import static com.maeultalk.gongneunglife.fragment.mainActivity.scrapFragment.PlaceFragment.mItems;
import static com.maeultalk.gongneunglife.key.Key.URL_IMAGES;

public class PlaceFragmentAdapter extends BaseAdapter{
...
//    private ArrayList<Favorite> mListData = new ArrayList<Favorite>();
    ...
    public PlaceFragmentAdapter(Context mContext, ArrayList<Favorite> mListData) {
        super();

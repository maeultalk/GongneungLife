...
import static com.maeultalk.gongneunglife.fragment.mainActivity.scrapFragment.ContentsFragment.mItems;
...
//    private ArrayList<Favorite> mListData = new ArrayList<Favorite>();
    ...
    public ContentsFragmentAdapter(Context mContext, ArrayList<Favorite> mListData) {
        super();

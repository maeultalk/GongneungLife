...
public class GoodOffRequest extends StringRequest {

    final static private String URL = URL_GOOD_OFF;
    private Map<String, String> parameters;

    public GoodOffRequest(String user, String content, Response.Listener<String> listener) {
